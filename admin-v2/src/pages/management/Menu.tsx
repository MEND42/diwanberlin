...
export function Menu() { return <StubPage title="Speisekarte" sub="Kategorien und Artikel verwalten" />; }
  ...
  return (
    <div className="p-6 flex flex-col items-center justify-center min-h-[400px] gap-4">
      ...
      <div className="text-center">
        <h2 className="font-display text-ink text-xl mb-1">{title}</h2>
        <p className="text-ink2 text-sm">{sub}</p>
